...
class Level3 : AppCompatActivity() {
    ...
    private var imageView8Position = mutableSetOf<Pair<Int, Int>>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView8Position = mutableSetOf(
            Pair(3, 3),
            Pair(4, 3)
        )
        ...
        allImageViewPositions.addAll(imageView8Position)
    ...
    private fun saveScore(score: Int) {
        ...
        editor.putInt(LEVEL_3_SCORE_KEY, score)
        editor.apply()
    }
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                if (isWithinBounds(newX, newY, view.width, view.height)) {
                    ...
                    when (view) {
                        ...
                        findViewById<ImageView>(R.id.imageView8) -> imageView8Position = newCoveredCells.toMutableSet()
                    }
    ...
    private fun checkWinningCondition() {
        ...
        if (allImageViewPositions.containsAll(winCells)) {
            ...
            Handler().postDelayed({
                when (stars) {
                    3 -> startActivity(Intent(this, Level3Stars3::class.java))
                    2 -> startActivity(Intent(this, Level3Stars2::class.java))
                    else -> startActivity(Intent(this, Level3Stars1::class.java))
                }
            }, 3000)
        }
    }
